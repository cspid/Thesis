...
public class SpeechHandleGetPosition : MonoBehaviour

{
    ...
    void Update()
    {
        print(target.rectTransform.position);
    ...
    void OnGUI()
    {
        ...
        if (GUI.changed)
        {
            ...
            // m_RectTransform.anchoredPosition = target.rectTransform;

            // point = cam.ScreenToWorldPoint(new Vector(mousePos.x, mousePos.y, cam.nearClipPlane));
        }
    }
}