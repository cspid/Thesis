...
namespace com.ootii.Setup.Modules
{
    ...
    public class BoneControllerSetupModule : SetupModule, IConfigureComponents
    {
        ...
        protected string mBoneFilters = "IK_|FK_|Roll";
        ...
        protected virtual void CreateFootToGroundMotor(BoneController rBoneController, bool rIsRightSide)
        {
        ...
        protected virtual void CreateLimbReachMotor(BoneController rBoneController, bool rIsRightSide)
        {
