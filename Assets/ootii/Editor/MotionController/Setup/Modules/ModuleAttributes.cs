...
namespace com.ootii.Setup
{
    ...
    ///// <summary>
    ///// The custom animation path used by the module
    ///// </summary>
    //[AttributeUsage(AttributeTargets.Class)]
    //public class ModuleAnimationPathAttribute : Attribute
    //{
    //    /// <summary>
    //    /// Name of the setup module
    //    /// </summary>
    ...
    //    /// </summary>
    //    /// <param name="rValue"></param>
    //    public ModuleAnimationPathAttribute(string rValue)
    //    {
    //        mValue = rValue;
    //    }
    ...
    //    /// <param name="rType">Type whose friendly name we want</param>
    //    /// <returns>String that is the friendly name for class name</returns>
    //    public static string GetPath(Type rType)
    //    {
    //        var lAttribute = ReflectionHelper.GetAttribute<ModuleAnimationPathAttribute>(rType);
    ...
    ///// <summary>
    ///// The Editor Prefs key used by the module
    ///// </summary>
    //[AttributeUsage(AttributeTargets.Class)]
    //public class ModulePrefsKeyAttribute : Attribute
    //{
    //    /// <summary>
    //    /// Name of the setup module
    //    /// </summary>
    ...
    //    /// </summary>
    //    /// <param name="rValue"></param>
    //    public ModulePrefsKeyAttribute(string rValue)
    //    {
    //        mValue = rValue;
    //    }
    ...
    //    /// <param name="rType">Type whose friendly name we want</param>
    //    /// <returns>String that is the friendly name for class name</returns>
    //    public static string GetPrefsKey(Type rType)
    //    {
    //        var lAttribute = ReflectionHelper.GetAttribute<ModulePrefsKeyAttribute>(rType);
