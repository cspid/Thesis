...
namespace com.ootii.Setup
{
    ...
    public static class CharacterSetupHelper 
    {
        ...
        public static ActorController ConfigureActorController(MotionController rMotionController, bool rIsPlayer)
        {
            ...
            var lLayerMask = new List<string>
            {
                "Default",
            ...
            LayerMask lGroundingLayers = LayerMask.GetMask(lLayerMask.ToArray());

            lLayerMask.Add(DefaultLayers.Names[DefaultLayers.Ladder]);
            //lLayerMask.Add(DefaultLayers.Names[DefaultLayers.NPC]);
            //if (!rIsPlayer)
            //{
            //    lLayerMask.Add(DefaultLayers.Names[DefaultLayers.Player]);
            //}
            
            lActorController.IsGroundingLayersEnabled = true;
            lActorController.GroundingLayers = lGroundingLayers;
            lActorController.CollisionLayers = LayerMask.GetMask(lLayerMask.ToArray());
