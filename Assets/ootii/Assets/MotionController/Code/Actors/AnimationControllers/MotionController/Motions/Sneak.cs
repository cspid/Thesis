...
namespace com.ootii.Actors.AnimationControllers
{
    ...
    public class Sneak : MotionControllerMotion
    {
        ...
        {
            m15080 = FindAnimationClip("Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Sneaking/Unity_Sneak.fbx/SneakForward.anim", "SneakForward");
            m15074 = FindAnimationClip("Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Sneaking/Unity_Sneak.fbx/SneakBackward.anim", "SneakBackward");
            m15086 = FindAnimationClip("Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Sneaking/Unity_Sneak.fbx/SneakIdle.anim", "SneakIdle");
            m15088 = FindAnimationClip("Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Sneaking/Unity_Sneak.fbx/SneakLeft.anim", "SneakLeft");
            m15090 = FindAnimationClip("Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Sneaking/Unity_Sneak.fbx/SneakRight.anim", "SneakRight");
            m14538 = FindAnimationClip("Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Idling/unity_Idle_IdleToIdlesR.fbx/IdlePose.anim", "IdlePose");
        ...
        public override void OnSettingsGUI()
        {
            ...
            m15080 = CreateAnimationField("SneakForward", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Sneaking/Unity_Sneak.fbx/SneakForward.anim", "SneakForward", m15080);
            m15074 = CreateAnimationField("SneakBackward", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Sneaking/Unity_Sneak.fbx/SneakBackward.anim", "SneakBackward", m15074);
            m15086 = CreateAnimationField("SneakIdle", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Sneaking/Unity_Sneak.fbx/SneakIdle.anim", "SneakIdle", m15086);
            m15088 = CreateAnimationField("SneakLeft", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Sneaking/Unity_Sneak.fbx/SneakLeft.anim", "SneakLeft", m15088);
            m15090 = CreateAnimationField("SneakRight", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Sneaking/Unity_Sneak.fbx/SneakRight.anim", "SneakRight", m15090);
            m14538 = CreateAnimationField("IdlePose", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Idling/unity_Idle_IdleToIdlesR.fbx/IdlePose.anim", "IdlePose", m14538);
